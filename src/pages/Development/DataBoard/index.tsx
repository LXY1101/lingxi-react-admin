...
function DevelopmentDataDashboard() {
  // 动态注入日期选择器主题色样式
  useEffect(() => {
    // 创建style元素
  ...
  return (
    <div className="development-data-dashboard">
      {/* 页面头部 */}
        ...
        <div className="header-content">
          <div className="title-with-icon">
            ...
            <div className="title-text">
              ...
              <p className="page-subtitle">查看项目开发进度和关键指标</p>
            </div>
          </div>
        </div>
...
export default DevelopmentDataDashboard;